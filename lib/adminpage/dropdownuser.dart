...
class DropDownUsers extends StatefulWidget {
  ...
  const DropDownUsers({Key? key, required this.width,required this.textFieldHeigth,required this.focusNode,required this.callBackUser}) : super(key: key);

  @override
  State<DropDownUsers> createState() {
    return DropDownUsersState();
  }
}

class DropDownUsersState extends State<DropDownUsers> {
