      ...
      showDialog(
          ...
          builder: (context) => AlertDialog(
                ...
                content: CustomText(
                    size: 22,
                    text:
                        "Sei sicuro di voler prenotare la lezione di ${widget.course.course_titol} tenuta da ${widget.professor.toStringDropDown()} il ${widget.day}/1 dalle ${splittedString[0]} alle ${splittedString[1]} ?"),
                actions: [
                  IconButton(
                    icon: const Icon(
